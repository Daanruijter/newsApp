...
class NewsModule extends VuexModule {
  ...
  async fetchNewsQuery(fetchBaseObject: FetchNews) {
    ...
    if (process.env.NODE_ENV === "production") {
      ...
      //There I saved a news item array for every country and category. For the input query I use a default.
      //This was needed to test the app. I can only fetch data 500 times a day on a free account.
